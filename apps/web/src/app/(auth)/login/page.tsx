...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px", position: "relative" }}>
      <div style={{ position: "fixed", top: "20%", left: "50%", transform: "translateX(-50%)", width: "500px", height: "500px", background: "radial-gradient(circle, rgba(43,74,125,0.07) 0%, transparent 70%)", pointerEvents: "none" }} />
      ...
      <div className="glass-card-elevated" style={{ width: "100%", maxWidth: "420px", padding: "48px 40px", animation: "fadeUp 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94) both" }}>
        <div style={{ marginBottom: "36px" }}>
          <h1 style={{ fontSize: "28px", fontWeight: 800, letterSpacing: "-0.03em", color: "var(--text-primary)", marginBottom: "8px" }}>Welcome back</h1>
          <p style={{ fontSize: "15px", color: "var(--text-muted)" }}>Sign in to your EVENT-LUX account</p>
        </div>

        <button
          onClick={() => { setGoogleLoading(true); signIn("google", { callbackUrl }); }}
          disabled={googleLoading}
          style={{ width: "100%", padding: "13px", background: "var(--bg-card)", border: "1px solid var(--border-strong)", borderRadius: "14px", fontSize: "15px", fontWeight: 600, color: "var(--text-primary)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", marginBottom: "24px", transition: "all 0.2s ease", opacity: googleLoading ? 0.7 : 1 }}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: "24px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "8px" }}>
              ...
              <Link href="/forgot-password" style={{ fontSize: "13px", color: "var(--text-primary)", fontWeight: 500, textDecoration: "none" }}>Forgot?</Link>
            </div>
        ...
        <p style={{ textAlign: "center", marginTop: "24px", fontSize: "14px", color: "var(--text-muted)" }}>
          ...
          <Link href="/register" style={{ color: "var(--text-primary)", fontWeight: 600, textDecoration: "none" }}>Sign up</Link>
        </p>
      </div>
